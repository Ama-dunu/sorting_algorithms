 ...
 * @subarr: The main array containing the two subarrays.
 * @buff: A buffer to store the sorted subarray.
 * @front: The front index of the main array.
 * @mid: The middle index that separates the two subarrays.
 * @back: The back index of the main array.
 */
 ...
 *
 * Description: Implements the top-down merge sort algorithm and prints
 * the array at each merge step.
 */
